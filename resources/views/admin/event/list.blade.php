        ...
        <table id="datatable" class=" table nowrap w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ isset($event->created_at) ? $event->created_at->format('d M Y, h:i A') : '' }}</td>
                    <td> 
