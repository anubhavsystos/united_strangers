                ...
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <select name="segment_type" id="offer-type" class="form-control ol-select2 ol-form-control" data-minimum-results-for-search="Infinity">
                            ...
                            <option value="work"> {{get_phrase('Work Event')}} </option>
                            <option value="sleep"> {{get_phrase('Sleep Event')}} </option>
                            <option value="play"> {{get_phrase('Play Event')}} </option>
                        </select>
                    </div>
                </div> 
                <div class="col-sm-6">
                    <div class="mb-3">
                        <label for="offer-category" class="form-label ol-form-label"> {{get_phrase('Event on')}} </label>
            ...
            <div class="tab-content pt-3" id="myTabContent">
                <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" required class="form-control ol-form-control" placeholder="{{get_phrase('Enter event title')}}" >
                    </div>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="title" class="form-label ol-form-label"> {{get_phrase('To Date')}} *</label>
                                <input type="date" name="to_date" required id="title" class="form-control ol-form-control" placeholder="{{get_phrase('Enter event title')}}" >
                            </div>
                            <div class="col-sm-6">
                                <label for="title" class="form-label ol-form-label"> {{get_phrase('From Date')}} *</label>
                                <input type="date" name="from_date"  required id="title" class="form-control ol-form-control" placeholder="{{get_phrase('Enter event title')}}" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <select name="visibility" id="visibility" class="form-control ol-form-control ol-select22 ol-select2" >
...
<script>
    ...
    //     var event_category = $("#category").val();
    //     if(!event_category){
    //         warning('event category is  ');
    //     }
    //     var event_title = $("#title").val();
    //     if(!event_title){
    //         warning('event title is  ');
    //     }
    //     var event_event_icon_image = $("#event-icon-image").val();
    //     if(!event_event_icon_image){
    //         warning('event image is  ');
    //     }
    //     var event_country = $("#country").val();
    //     if(!event_country){
    //         warning('event country is  ');
    //     }
    //     var event_city = $("#city").val();
    //     if(!event_city){
    //         warning('event city is  ');
    //     }
    //     var event_address = $("#list_address").val();
    //     if(!event_address){
    //         warning('event address is  ');
    //     }
    //     var event_post_code = $("#post_code").val();
    //     if(!event_post_code){
    //         warning('event post code is  ');
    //     }
    //     var event_latitude = $("#latitude").val();
    //     if(!event_latitude){
    //         warning('event latitude is  ');
    //     }
    //     var event_longitude = $("#longitude").val();
    //     if(!event_longitude){
    //         warning('event longitude is  ');
    //     }
    //     var event_visibility = $("#visibility").val();
    //     if(!event_visibility){
    //         warning('event visibility is  ');
    //     }
    //     if(event_event_icon_image && event_title && event_category && event_country && event_city && event_address && event_post_code && event_latitude && event_longitude && event_visibility){
