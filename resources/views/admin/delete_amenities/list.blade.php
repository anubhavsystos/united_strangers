        ...
        <div class="ol-card mt-3">
            <div class="ol-card-body p-3 ">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    @elseif ($type == 'work' || $type == 'sleep' || $type == 'play')
                        <a href="{{route('admin.amenities.item',['type'=>$type,'item'=>'feature'])}}" class="nav-link text-start {{request()->is('admin/amenities-item/work/feature') || request()->is('admin/amenities-item/sleep/feature') || request()->is('admin/amenities-item/play/feature')?'active':''}}"> {{get_phrase('Features')}} </a>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <div class="">
                        <table id="datatable" class="table nowrap w-100">
                            <thead>
                                <tr>
                                    <th> {{get_phrase('ID')}} </th>
                                    @if ($type == 'car' || $type == 'work' || $type == 'sleep' || $type == 'play')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> {{$num++}} </td>
                                    @if ( $type == 'work' || $type == 'sleep' || $type == 'play')
                                    <td> {{$amenitie->name}} </td>
                                    <td>
