        ...
        <ul class="px-14px pb-24px">
                ...
                <ul class="first-sub-menu">
                    <li class="sidebar-second-li second-li-have-sub {{request()->is('admin/listings*') || request()->is('admin/listing-edit*')?'active':''}}">
                        ...
                        <ul class="second-sub-menu">
                            <li class="sidebar-third-li {{request()->is('admin/listings/sleep*') || request()->is('admin/listing-edit/sleep*')?'active':''}}"><a href="{{ route('admin.listing.list',['type'=>'sleep'])}}"> {{get_phrase('Sleep')}} </a></li>
                            <li class="sidebar-third-li {{request()->is('admin/listings/work*') || request()->is('admin/listing-edit/work*')?'active':''}}"><a href="{{ route('admin.listing.list',['type'=>'work'])}}"> {{get_phrase('Work')}} </a></li>                           
                            <li class="sidebar-third-li {{request()->is('admin/listings/play*') || request()->is('admin/listing-edit/play*')?'active':''}}"><a href="{{ route('admin.listing.list',['type'=>'play'])}}"> {{get_phrase('Play')}} </a></li>
                        </ul>
                    </li>
            ...
            <li class="sidebar-first-li {{request()->is('admin/offers*')?'active':''}}">
                <a href="{{ route('admin.offers')}}">
                    ...
                    <div class="text">
                        <span> {{get_phrase('Offers')}} </span>
                    </div>
                </a>
            </li>
            <li class="sidebar-first-li {{request()->is('admin/event*')?'active':''}}">
            ...
            <li class="sidebar-first-li {{request()->is('admin/profile')?'active':''}}"><a href="{{ route('admin.profile')}}">
               <span>
                ...
                <div class="text"><span> {{get_phrase('My Profile')}} </span>
                </div>
            </a></li>
        </ul>
    </nav>
