            ...
            <tbody>
                ...
                <tr>
                        ...
                        <div class="dAdmin_profile d-flex flex-wrap  min-w-200px gap-2">
                            <div class="dAdmin_profile_name">
                                <p class="fs-14px mb-1">
                                    ...
                                    {{$listings['user_name'] ?? 'N/A'}} </p>
                                <p class=" fs-14px"> {{$listings['title'] ?? 'N/A'}}  </p>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                            <div class="dAdmin_profile_name">
                                <p class="fs-14px capitalize">   {{$listings['listing_type'] ?? 'N/A'}} </p>
                            </div>
                        </div> 
                    </td>
                    <td> 
                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                            <div class="dAdmin_profile_name">
                                <p class="fs-14px mb-1"> {{$listings['user_name'] ?? 'N/A'}} </p>
                                <p class="fs-14px mb-1"> {{$listings['user_email'] ?? 'N/A'}} </p>
                                <p class="fs-14px mb-1"> {{$listings['user_phone'] ?? 'N/A'}} </p>
                     ...
                     <td> 
                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                            <div class="dAdmin_profile_name">
                                <p class="fs-14px mb-1"><b>{{get_phrase('Report Type : ')}} </b> {{ isset($listings['report_type']) ? str_replace('_', ' ', $listings['report_type'] ) : '' }}</p>
                                <p class="fs-14px report-text line-25">
                                    ...
                                    @if(strlen($listings['report']) > 300)
                                        ...
                                        <span class="full-text line-25 d-none">{{$listings['report'] ?? 'N/A'}} {{ $listings->report }}</span>
                                    @endif
                                </p>  
                            </div>
                        </div>
                    ...
                    {{-- <td>
                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                            <div class="dAdmin_profile_name">
                                <p class="fs-14px capitalize">{{ isset($listings['report_type']) ? str_replace('_', ' ', $listings['report_type']) : '' }}</p>
                            </div>
                        </div> 
                    </td> --}}
                    {{-- <td>
                    ...
                    <td> 
                        <div class="dropdown ol-icon-dropdown">
                            ...
                            <ul class="dropdown-menu">                              
                              <li><a class="dropdown-item fs-14px"onclick="delete_modal('{{route('admin.listing-global.delete',['type'=>$listings['listing_type'], 'listing_id'=>$listings['id']])}}')"  href="javascript:void(0);"> {{get_phrase('Listings Delete')}} </a></a></li>
