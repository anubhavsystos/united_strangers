                        ...
                        <label class="form-check-label w-100" onclick="sleep_feature_checked('{{$key}}')" for="flexCheck{{$key}}">
                            <div class="card mb-3 team-checkbox me-2">
                                <div class="col-md-12 team-body feature-body">
                                    ...
                                    <div class="checked d-none" id="sleep-feature-checked{{$key}}">
                        ...
                        <label class="form-check-label w-100" onclick="sleep_feature_checked('{{$key}}')" for="flexCheck{{$key}}">
                            <div class="card mb-3 team-checkbox me-2">
                                <div class="col-md-12 team-body feature-body">
                                    ...
                                    <div class="checked @if($room->feature && $room->feature != 'null' && in_array($feature->id, json_decode($room->feature))) @else d-none @endif" id="sleep-feature-checked{{$key}}">
                                        <i class="fas fa-check"></i>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function sleep_feature_checked(key) {
        ...
        document.getElementById('sleep-feature-checked' + key).classList.toggle('d-none');
    }
</script>