                                        ...
                                        <table id="datatable" class=" table nowrap w-100">
                                                <thead class="ca-thead">
                                                    <tr class="ca-tr">
                                                        ...
                                                        <th scope="col" class="ca-title-14px ca-text-dark">{{get_phrase('Property Name')}}</th>
                                            ...
                                            <tbody>
                                                @foreach ($appointments as $key => $appointment)    
                                                    <tr class="ca-tr">
                                                        ...
                                                        <td class="min-w-140px">
                                                            <div class=" align-items-center gap-2"><p class="badge-dark">{{isset($appointment['customer_phone']) ? $appointment['customer_phone'] : ''}} </p><br>
                                                            <p class="ca-subtitle-14px ca-text-dark mb-2 line-1"> {{!empty($appointment['phone']) ? $appointment['phone'] : ''}}</p></div>
                                                        </td>
                                                        <td class="min-w-140px">
        ...
        <div class="modal-dialog">
            <form id="appointmentFormWork" method="POST" action="{{ route('appointments.store') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Work Appointment</h5>
