...
<div class="row">
    <div class="col-lg-6">
        <form class="mt-5" action="{{ route('admin.homepage-setting-update') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="fpb-7 mb-3">
                <label for="sleep_banner_description" class="form-label ol-form-label"> {{ get_phrase('Real Estate Banner Description') }} </label>
                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($RealEstateBanner->image))
                                        <img src="{{ asset('uploads/homepage/work/'. $RealEstateBanner->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 real-preview h-200 cover w-100">
                                    @else
                            ...
                            <div class="box">
                                <div class="upload-options">
                                    @if(!empty($RealEstateDiscount->image))
                                        <img src="{{ asset('uploads/homepage/work/'. $RealEstateDiscount->image) }}" alt="" class="bg-dark_2 radious-15px px-2 py-2 real-booking-preview h-200 cover w-100">
                                    @else
