                                        ...
                                        <table class="table eTable">
                                            <div class="chart-widget-list">
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    <span class="ms-auto float-end">CODEGOOD.NET</span>
                                                </p>
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    @if ($application_details['product_license'] == 'valid')
                                                        <span class="ms-auto float-end badge bg-success text-capitalize">CODEGOOD.NET</span>
                                                    @else
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    @if ($application_details['customer_name'] != 'invalid')
                                                        <span class="ms-auto float-end">CODEGOOD.NET</span>
                                                    @else
                                                        <span class="ms-auto float-end"><span class="badge bg-danger">CODEGOOD.NET</span></span>
                                                    @endif
                                                </p>
