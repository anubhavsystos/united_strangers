                            ...
                            <table class="table ca-table ca-table-width">
                                ...
                                <tbody class="ca-tbody">
                                    ...
                                    @php
                                        ...
                                        }elseif($wishlist->type == 'sleep'){
                                            $listing = App\Models\SleepListing::where('id', $wishlist->listing_id)->first();
                                        }elseif($wishlist->type == 'work'){
                                            $listing = App\Models\WorkListing::where('id', $wishlist->listing_id)->first();
                                        }elseif($wishlist->type == 'play'){
                                            $listing = App\Models\PlayListing::where('id', $wishlist->listing_id)->first();
                                        }
                                    @endphp
                                    <tr class="ca-tr">
                                      <td>
