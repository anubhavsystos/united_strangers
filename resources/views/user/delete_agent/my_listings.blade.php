                            ...
                            <form action="{{ route('agent.listingsFilter') }}" method="GET">
                                <div class="d-flex column-gap-3 row-gap-2 flex-wrap">
                                    ...
                                    <select class="at-nice-select sm-secondary-niceselect" name="type">
                                        ...
                                        <option value="sleep" {{ request('type') == 'sleep' ? 'selected' : '' }}>{{ get_phrase('Sleep') }}</option>
                                        <option value="play" {{ request('type') == 'play' ? 'selected' : '' }}>{{ get_phrase('Play') }}</option>
                                        <option value="work" {{ request('type') == 'work' ? 'selected' : '' }}>{{ get_phrase('Work') }}</option>
