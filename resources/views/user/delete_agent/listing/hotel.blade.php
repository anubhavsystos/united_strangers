<div class="ca-content-card p-4">
    ...
    <form class="position-relative" action="{{route('user.listing.store',['type'=>'sleep'])}}" id="form-action" method="post" enctype="multipart/form-data">
        @csrf
    <div class="subMit">
...
<script>
    ...
    $("#form-action-btn").on('click', function() {
        ...
        if(listing_listing_icon_image && listing_size && listing_bath && listing_bed && listing_price && listing_title && listing_category && listing_country && listing_city && listing_address && listing_post_code && listing_latitude && listing_longitude && listing_visibility && listing_dimension && listing_is_popular){
