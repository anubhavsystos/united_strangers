                ...
                <div class="col-lg-6 col-xl-5">
                    <div>
                        <div class="mb-40px">
                            ...
                            <p class="in-subtitle-2">{{get_phrase('Promote your business and get discovered with ease — List your services on Listing united_strangers, the smart directory solution.')}}</p>
                        </div>
                        <div class="mb-40px">
