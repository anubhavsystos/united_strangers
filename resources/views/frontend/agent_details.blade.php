        ...
        <div class="row row-28 mb-90 mt-3">
            ...
            <div class="col-lg-8">
                <div class="aGdescription">
                    ...
                    <ul>
                        @php 
                           $sleep = App\Models\SleepListing::where('user_id', $users->id)->count();
                           $Play = App\Models\PlayListing::where('user_id', $users->id)->count();
                           $Work = App\Models\WorkListing::where('user_id', $users->id)->count();
