@if (request()->is('sleep'))
    <div class="ht-header-banner-wrap" style="background-image: url('{{ isset($SleepBanner->image) && $SleepBanner->image ? asset('uploads/homepage/sleep/' . $SleepBanner->image) : asset('assets/frontend/images/sleep/sleep-hero-banner.svg') }}');">
                                    ...
                                    <div class="offcanvas-body">
                                        <nav>
                                            <ul class="at-home-navbar-nav ht-home-navbar-nav">
                                                        ...
                                                        <ul class="first-sub-menu">
                                                            @foreach ($menu_items as $key => $item)
                                                                @if ($key >= 2)
                                                                    ...
                                                                    @elseif($item == 'Play')
                                                                        <li><a class="atn-sub-nav-link {{ request()->routeIs('playhome') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Play') }}</a></li>
                                                                    @elseif($item == 'Beauty')
                                                ...
                                                <li><a href="{{ route('listing.view', ['type' => 'sleep', 'view' => 'grid']) }}" class="at-home-nav-link {{ request()->routeIs('listing.view') ? 'active' : '' }}">
                                                        {{ get_phrase('Listing') }}
                                                    </a></li>
                                            </ul>
                                        </nav>
        ...
        <section class="ht-banner-section mb-60px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p class="dm-uppercase-text-16px text-center">{{ get_phrase('Sleep') }}</p>
                        <h1 class="dm-title-60px text-capitalize fw-semibold text-white mb-30px text-center">{{ $SleepBanner->title ?? '' }}</h1>
                        <p class="in-subtitle-16px text-white text-center max-w-723px mx-auto mb-40px">{{ $SleepBanner->description ?? '' }}</p>
                        <div class="mb-60px d-flex align-items-center gap-3 flex-wrap justify-content-center">
                            <a href="{{ route('listing.view', ['type' => 'sleep', 'view' => 'grid']) }}" class="btn ht-btn-primary">{{ get_phrase('Learn More') }}</a>

                            <a href="{{ $SleepBanner->video_url ?? asset('image/placeholder.png') }}" 
                                class="ht-play-btn video-popup d-flex align-items-center gap-12px" 
                                data-maxwidth="900px" 
                                data-vbtype="{{ $SleepBanner->video_url ? 'video' : '' }}">
...
@else
    <header class="{{ request()->is('sleep') ? '' : 'header-section' }} mb-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="at-home-menu-wrap">
