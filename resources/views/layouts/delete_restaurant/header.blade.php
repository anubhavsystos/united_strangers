 <!-- Start Header -->
 <header class="{{request()->is('play')?'':'header-section hd_section'}}">
    <div class="container">
        <div class="row">
            <div class="col-12">
                                ...
                                <nav>
                                    <ul class="header-nav-list">
                                        ...
                                        @foreach ($menu_items as $key => $item)
                                            @if($key < 2) 
                                                @if($item == 'sleep') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Sleep') }}</a></li>
                                                @elseif($item == 'work') 
                                                ...
                                                @elseif($item == 'Play') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('playhome') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Play') }}</a></li>
                                                @elseif($item == 'Beauty') 
                                        ...
                                        <li><a href="{{ route('listing.view', ['type' => 'play', 'view' => 'grid']) }}" 
