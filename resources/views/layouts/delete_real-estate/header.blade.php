@if (request()->is('work'))
    ...
    @endphp
    <div class="real-header-banner-wrap mb-100px" style="background-image: url('{{ isset($RealEstateBanner->image) && $RealEstateBanner->image ? asset('uploads/homepage/work/' . $RealEstateBanner->image) : asset('assets/frontend/images/work/work-banner.webp') }}');">
        <!-- Start Header -->
                                        ...
                                        <nav>
                                            <ul class="at-home-navbar-nav real-home-navbar-nav">
                                                ...
                                                @foreach ($menu_items as $key => $item)
                                                    @if ($key < 2)
                                                        @if ($item == 'sleep')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Sleep') }}</a></li>
                                                        @elseif($item == 'work')
                                                        ...
                                                        @elseif($item == 'Play')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('playhome') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Play') }}</a></li>
                                                        @elseif($item == 'Beauty')
                                                        ...
                                                        <ul class="first-sub-menu">
                                                            @foreach ($menu_items as $key => $item)
                                                                @if ($key >= 2)
                                                                    ...
                                                                    @elseif($item == 'Play')
                                                                        <li><a class=" {{ request()->routeIs('playhome') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Play') }}</a></li>
                                                                    @elseif($item == 'Beauty')
                                                ...
                                                <li><a href="{{ route('listing.view', ['type' => 'work', 'view' => 'grid']) }}" class="at-home-nav-link {{ request()->routeIs('listing.view') ? 'active' : '' }}">
                                                        {{ get_phrase('Listing') }}
                                                    </a></li>
                                            </ul>
                                        </nav>
                    ...
                    <div class="col-12">
                        <div class="d-flex real-title-certification-wrap position-relative">
                            <div class="real-banner-title-wrap mx-100">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <a href="{{ route('listing.view', ['type' => 'work', 'view' => 'grid']) }}" class="btn re-btn-dark">{{ get_phrase('All Listing') }}</a>
                                    </div>
                                    <div class="col-lg-8">
                                        ...
                                        <div class="tab-content real-search-tab-content" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-one" role="tabpanel" aria-labelledby="pills-one-tab" tabindex="0">
                                                @php
                                                    $highestPrice = ceil((App\Models\WorkListing::max('price') + 1) / 4) * 4;
                            ...
                            <div class="real-certification-img eRealEstate">
                                <img src="{{ asset('assets/frontend/images/work/certification-circle.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
