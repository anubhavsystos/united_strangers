                                    ...
                                    <nav class="header-nav">
                                        <ul class="header-nav-list">
                                            ...
                                            @foreach ($menu_items as $key => $item)
                                                @if ($key < 2)
                                                    @if ($item == 'sleep')
                                                        <li><a class="first-a {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Sleep') }}</a></li>
                                                    @elseif($item == 'work')
                                                    ...
                                                    @elseif($item == 'Play')
                                                        <li><a class="first-a {{ request()->routeIs('playhome') ? 'active' : '' }}" href="{{ route('playhome') }}">{{ get_phrase('Play') }}</a></li>
                                                    @elseif($item == 'Beauty')
