...
if(isset($type) && isset($listing_id)){
       if($type == 'beauty'){
            ...
            $seo_field = App\Models\WorkListing::where('id', $listing_id)->first();
        }elseif($type == 'sleep'){
            $seo_field = App\Models\SleepListing::where('id', $listing_id)->first();
        }elseif($type == 'play'){
            $seo_field = App\Models\PlayListing::where('id', $listing_id)->first();
        }
}else{
