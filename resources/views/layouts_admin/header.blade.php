@php
    $currect_route_name = Route::currentRouteName();
@endphp
<!-- Start Header -->
            ...
            <div class="col-md-12">
                <div class="main-header-area d-flex align-items-center justify-content-between">
                    ...
                    <div class="header-right-area d-flex align-items-center">
                        <form action="{{ route('ListingsFilter') }}" class="header-search-form" method="get" onsubmit="return validateSearch()">
                            <div class="header-search-wrap d-flex align-items-center">
                                ...
                                <select class="search-select" name="type" id="type">
                                    ...
                                    <option value="hotel" @if ($currect_route_name == 'sleep.home' || request()->type == 'hotel') selected @endif>{{ get_phrase('Hotel') }}</option>
                                    <option value="restaurant" @if ($currect_route_name == 'play.home' || request()->type == 'restaurant') selected @endif>{{ get_phrase('Restaurant') }}</option>
                                    <option value="real-estate" @if ($currect_route_name == 'work.home' || request()->type == 'real-estate') selected @endif>{{ get_phrase('Real-Estate') }}</option>
                                ...
                                <button type="submit" class="search-submit-btn">
                                    <img src="{{ asset('assets/frontend/images/icons/search-white.svg') }}" alt="">
                                </button>
                            </div>
                        </form>
                                    ...
                                    <nav class="header-nav">
                                        <ul class="header-nav-list">
                                            ...
                                            @foreach ($menu_items as $key => $item)
                                                @if ($key < 2)
                                                    @if ($item == 'Hotel')
                                                        <li><a class="first-a {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                    @elseif($item == 'Real-Estate')
                                                        <li><a class="first-a {{ request()->routeIs('work.home') ? 'active' : '' }}" href="{{ route('work.home') }}">{{ get_phrase('Real Estate') }}</a></li>
                                                    @elseif($item == 'Car')
                                                        <li><a class="first-a {{ request()->routeIs('car.home') ? 'active' : '' }}" href="{{ route('car.home') }}">{{ get_phrase('Car') }}</a></li>
                                                    @elseif($item == 'Restaurant')
                                                        <li><a class="first-a {{ request()->routeIs('play.home') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                    @elseif($item == 'Beauty')
                                                        <li><a class="first-a {{ request()->routeIs('beauty.home') ? 'active' : '' }}" href="{{ route('beauty.home') }}">{{ get_phrase('Beauty') }}</a></li>
                                                    @endif
                                                @endif
                                            @endforeach
