 <!-- Start Header -->
 <header class="{{request()->is('restaurant')?'':'header-section hd_section'}}">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="at-home-menu-wrap">
                    ...
                    <div class="at-home-menu-button rt-home-menu-button">
                                ...
                                <nav>
                                    <ul class="header-nav-list">
                                        ...
                                        @foreach ($menu_items as $key => $item)
                                            @if($key < 2) 
                                                @if($item == 'Hotel') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                @elseif($item == 'Real-Estate') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('work.home') ? 'active' : '' }}" href="{{ route('work.home') }}">{{ get_phrase('Real Estate') }}</a></li>
                                                @elseif($item == 'Car') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('car.home') ? 'active' : '' }}" href="{{ route('car.home') }}">{{ get_phrase('Car') }}</a></li>
                                                @elseif($item == 'Restaurant') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('play.home') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                @elseif($item == 'Beauty') 
                                                    <li><a class="first-a p-0 {{ request()->routeIs('beauty.home') ? 'active' : '' }}" href="{{ route('beauty.home') }}">{{ get_phrase('Beauty') }}</a></li>
                                                @endif
                                            @endif
                                        @endforeach
                                        ...
                                        @if(count($menu_items) > 2)
                                            <li class="have-sub-menu">
                                                <a href="javascript:void(0);" class="first-a p-0">
                                        ...
                                        <li><a href="{{ route('listing.view', ['type' => 'restaurant', 'view' => 'grid']) }}" 
                        ...
                        <div class="at-home-search-login-button">
                            <div class="at-home-nav-search rt-home-nav-search d-none d-md-block">
                                <form role="search" method="get" class="at-home-search-form" action="{{ route('ListingsFilter') }}">
                                    <input type="hidden" name="type" value="restaurant">
                                    <input type="hidden" name="view" value="grid">
                                   <div class="at-home-nav-label">
                                        <input type="search" value="{{$_GET['title'] ?? ''}}" class="at-home-search-input rt-home-search-input" placeholder="Search …"  name="title" title="Search for:">
                                        <button type="submit" class="at-home-search-btn rt-home-search-btn">
                                            <img src="{{asset('assets/frontend/images/icons/search-white-16.svg')}}" alt="search">
                                        </button>
                                   </div>
                                </form> 
                            </div>
                            ...
                            @endif
                            @if (check_subscription(user('id'))) 
                            <a href="{{ route('agent.my_listings') }}" class="btn rt-btn-danger at-home-listing-btn d-flex align-items-center gap-2">
                                <img src="{{ asset('assets/frontend/images/icons/plus-white-8.svg') }}" alt="">
                                <span>{{get_phrase('Add Listing')}}</span>
                            </a>
                           @else 
                            <a href="{{route('customer.become_an_agent')}}" class="btn rt-btn-danger at-home-listing-btn d-flex align-items-center gap-2">
                                <img src="{{ asset('assets/frontend/images/icons/plus-white-8.svg') }}" alt="">
                                <span>{{get_phrase('Add Listing')}}</span>
                            </a>
                        @endif
                            <button class="btn at-home-menu-btn rt-home-menu-btn d-xl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 20 20" xml:space="preserve" class=""><g><path d="M21 7H8a1 1 0 0 1 0-2h13a1 1 0 0 1 0 2zm1 5a1 1 0 0 0-1-1H3a1 1 0 0 0 0 2h18a1 1 0 0 0 1-1zm0 6a1 1 0 0 0-1-1h-9a1 1 0 0 0 0 2h9a1 1 0 0 0 1-1z" fill="#F77214" opacity="1" data-original="#000000" class=""></path></g></svg>
                            </button>
                        </div>
                    </div>
                </div>
