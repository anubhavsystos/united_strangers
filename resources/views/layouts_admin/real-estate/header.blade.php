@if (request()->is('real-estate'))
    ...
    @endphp
    <div class="real-header-banner-wrap mb-100px" style="background-image: url('{{ isset($RealEstateBanner->image) && $RealEstateBanner->image ? asset('uploads/homepage/real-estate/' . $RealEstateBanner->image) : asset('assets/frontend/images/real-estate/real-estate-banner.webp') }}');">
        <!-- Start Header -->
        <header class="real-home-header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="at-home-menu-wrap real-home-menu-wrap">
                            <div>
                                <a href="" class="d-block atn-logo">
                                    ...
                                    @else
                                        <img src="{{ asset('assets/frontend/images/logo-for-light.svg') }}" alt="" class="radious-15px px-2 py-2 light-logo-preview h-77">
                                    @endif
                                </a>
                            </div>
                            <div class="at-home-menu-button">
                                ...
                                <div class="offcanvas-xl offcanvas-end at-home-offcanvas" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                                    ...
                                    <div class="offcanvas-body">
                                        <nav>
                                            <ul class="at-home-navbar-nav real-home-navbar-nav">
                                                @php
                                                ...
                                                @foreach ($menu_items as $key => $item)
                                                    @if ($key < 2)
                                                        @if ($item == 'Hotel')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                        @elseif($item == 'Real-Estate')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('work.home') ? 'active' : '' }}" href="{{ route('work.home') }}">{{ get_phrase('Real Estate') }}</a></li>
                                                        @elseif($item == 'Car')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('car.home') ? 'active' : '' }}" href="{{ route('car.home') }}">{{ get_phrase('Car') }}</a></li>
                                                        @elseif($item == 'Restaurant')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('play.home') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                        @elseif($item == 'Beauty')
                                                            <li><a class="at-home-nav-link {{ request()->routeIs('beauty.home') ? 'active' : '' }}" href="{{ route('beauty.home') }}">{{ get_phrase('Beauty') }}</a></li>
                                                        @endif
                                                    @endif
                                                @endforeach
                                                    ...
                                                    <li class="have-sub-menu">
                                                        ...
                                                        <ul class="first-sub-menu">
                                                            @foreach ($menu_items as $key => $item)
                                                                @if ($key >= 2)
                                                                    @if ($item == 'Hotel')
                                                                        <li><a class=" {{ request()->routeIs('sleep.home') ? 'active' : '' }}" href="{{ route('sleep.home') }}">{{ get_phrase('Hotel') }}</a></li>
                                                                    @elseif($item == 'Real-Estate')
                                                                    ...
                                                                    @elseif($item == 'Restaurant')
                                                                        <li><a class=" {{ request()->routeIs('play.home') ? 'active' : '' }}" href="{{ route('play.home') }}">{{ get_phrase('Restaurant') }}</a></li>
                                                                    @elseif($item == 'Beauty')
                                                ...
                                                <li><a href="{{ route('listing.view', ['type' => 'real-estate', 'view' => 'grid']) }}" class="at-home-nav-link {{ request()->routeIs('listing.view') ? 'active' : '' }}">
                                                        {{ get_phrase('Listing') }}
                                                    </a></li>
                                            </ul>
                                        </nav>
                                ...
                                <div class="at-home-search-login-button">
                                    <div class="at-home-nav-search d-none d-md-block">
                                        <form class="at-home-search-form" action="{{ route('ListingsFilter') }}" method="get">
                                            ...
                                            <div class="at-home-nav-label">
                                                <input type="search" value="{{ $_GET['title'] ?? '' }}" class="at-home-search-input real-home-search-input" placeholder="Search …" title="Search for:" name="title">
                                                <button type="submit" class="at-home-search-btn">
                                    ...
                                    @if (check_subscription(user('id')))
                                        <a href="{{ route('agent.my_listings') }}" class="btn re-btn-dark at-home-listing-btn re-home-listing-btn d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/frontend/images/icons/plus-white-8.svg') }}" alt="">
                                            <span>{{ get_phrase('Add Listing') }}</span>
                                        </a>
                                    @else
                                        <a href="{{ route('customer.become_an_agent') }}" class="btn re-btn-dark at-home-listing-btn re-home-listing-btn d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/frontend/images/icons/plus-white-8.svg') }}" alt="">
                                            <span>{{ get_phrase('Add Listing') }}</span>
                                        </a>
                                    @endif
                                    <button class="btn at-home-menu-btn re-home-menu-btn d-xl-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 20 20" xml:space="preserve" class="">
                                            <g>
                                                <path d="M21 7H8a1 1 0 0 1 0-2h13a1 1 0 0 1 0 2zm1 5a1 1 0 0 0-1-1H3a1 1 0 0 0 0 2h18a1 1 0 0 0 1-1zm0 6a1 1 0 0 0-1-1h-9a1 1 0 0 0 0 2h9a1 1 0 0 0 1-1z" fill="#F77214" opacity="1" data-original="#000000" class=""></path>
                                            </g>
                                        </svg>
                                    </button>
                                </div>
        ...
        <!-- End Header -->
        <!-- Start Banner Area -->
        <section class="real-banner-section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex real-title-certification-wrap position-relative">
                            <div class="real-banner-title-wrap mx-100">
                                <h1 class="mb-30px mx-787 text-white in-title-94px text-capitalize">{{ $RealEstateBanner->title }}</h1>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <p class="mb-40px  text-white in-subtitle-16px fw-medium max-w-485px">{{ $RealEstateBanner->description }}</p>
                                        <a href="{{ route('listing.view', ['type' => 'real-estate', 'view' => 'grid']) }}" class="btn re-btn-dark">{{ get_phrase('All Listing') }}</a>
                                    </div>
                                    <div class="col-lg-8">
                                        <ul class="nav nav-pills nav-fill real-banner-pills mt-5" id="pills-tab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="pills-one-tab" data-bs-toggle="pill" data-bs-target="#pills-one" type="button" role="tab" aria-controls="pills-one" aria-selected="true">{{ get_phrase('Sell') }}</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-two-tab" data-bs-toggle="pill" data-bs-target="#pills-two" type="button" role="tab" aria-controls="pills-two" aria-selected="false">{{ get_phrase('Rent') }}</button>
                                            </li>
                                        </ul>
                                        <div class="tab-content real-search-tab-content" id="pills-tabContent">
                                                ...
                                                <form action="{{ route('ListingsFilter') }}" method="get">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <div class="real-search-filter real-search-filter-border">
                                                            <div class="eReal d-flex align-items-center gap-2 mb-6px">
                                                                <img src="{{ asset('assets/frontend/images/icons/document-text-black-22.svg') }}" alt="icon">
                                                                <p class="in-subtitle3-14px">{{ get_phrase('Categories') }}</p>
                                                            </div>
                                                            <select class="at-nice-select transparent-nice-select transparent-nice-select-arrow real-nice-select min-w-134px" name="category">
                                                        ...
                                                        <div class="real-search-filter real-search-filter-border">
                                                            <div class="eReal d-flex align-items-center gap-2 mb-6px">
                                                                <img src="{{ asset('assets/frontend/images/icons/location-black-22.svg') }}" alt="icon">
                                                                <p class="in-subtitle3-14px">{{ get_phrase('Cities') }}</p>
                                                            </div>
                                                            <select class="at-nice-select transparent-nice-select transparent-nice-select-arrow real-nice-select min-w-134px" name="city">
                                                                <option value="all">{{ get_phrase('Choose City') }}</option>
                                                        ...
                                                        <div class="real-search-filter real-search-filter-border">
                                                            <div class="eReal d-flex align-items-center gap-2 mb-6px">
                                                                <img src="{{ asset('assets/frontend/images/icons/dollar-circle-black-22.svg') }}" alt="icon">
                                                                <p class="in-subtitle3-14px">{{ get_phrase('Budget') }}</p>
                                                            </div>

                                                            <select id="searched_price" class="at-nice-select transparent-nice-select transparent-nice-select-arrow real-nice-select min-w-134px" onchange="updateHiddenFields()">
                                                        ...
                                                        <button class="btn rebtn re-btn-dark mb-3 mb-xxl-0 mt-sm-3 mt-md-0">
                                            ...
                                            <div class="tab-pane fade" id="pills-two" role="tabpanel" aria-labelledby="pills-two-tab" tabindex="0">
                                                <form action="{{ route('ListingsFilter') }}" method="get">
                                                    ...
                                                    <div class="d-flex align-items-center  real-search-filter-wrap">
                                                        ...
                                                        <button class="btn rebtn re-btn-dark">
                                                            <img src="{{ asset('assets/frontend/images/icons/search-white-20.svg') }}" alt="">
                                                            <span>{{ get_phrase('Search') }}</span>
                                                        </button>
                                                    </div>
                            ...
                            <div class="real-certification-img eRealEstate">
                                <img src="{{ asset('assets/frontend/images/real-estate/certification-circle.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
@else
    <header class="{{ request()->is('real-estate') ? '' : 'header-section' }} mb-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
