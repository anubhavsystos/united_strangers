                            ...
                            <div class="row">
                               ...
                               <div class="col-lg-3 col-md-4 col-6 mb-3">
                                    <div class="footer-middle-nav">
                                        ...
                                        <ul>
                                            <li><a href="{{route('play.home')}}">{{get_phrase('Restaurant')}}</a></li>
                                            <li><a href="{{route('sleep.home')}}">{{get_phrase('Hotel')}}</a></li>
                                            <li><a href="{{route('beauty.home')}}">{{get_phrase('Beauty')}}</a></li>
                                            <li><a href="{{route('work.home')}}">{{get_phrase('Real-Estate')}}</a></li>
