<!-- Start Header -->
<header class=" {{request()->is('beauty')?'':'header-section'}}">
    <div class="container">
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="offcanvas-xl offcanvas-end at-home-offcanvas" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                            <div class="offcanvas-header">
                                <div>
                                    <a href="">
                                        @if(get_frontend_settings('light_logo'))
                                        <img src="{{ asset('uploads/logo/' . get_frontend_settings('light_logo')) }}" alt="" class="radious-15px px-2 py-2  h-77">
                                    @else
                                        <img src="{{ asset('uploads/logo/light_logo.svg') }}" alt="" class="radious-15px px-2 py-2 h-77">
                                    @endif
                                    </a>
                                </div>
                            ...
                            <div class="offcanvas-body">
                                <nav> 
                                    <ul class="header-nav-list">
                                        ...
                                        <li><a href="{{ route('listing.view', ['type' => 'beauty', 'view' => 'grid']) }}" 
