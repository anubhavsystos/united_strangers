...
Route::get('/details', [FrontendController::class, 'details'])->name('home.details');
Route::get('/show_products_segment', [FrontendController::class, 'show_products_segment'])->name('show_products_segment');
Route::get('/sleep', [FrontendController::class, 'sleep_home'])->name('sleep.home');
...
Route::get('/work', [FrontendController::class, 'realestate_home'])->name('work.home');
Route::get('/play', [FrontendController::class, 'play_home'])->name('play.home');
...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    // Homepage Settings (Beauty, Car , play, sleep, Real Estate)
